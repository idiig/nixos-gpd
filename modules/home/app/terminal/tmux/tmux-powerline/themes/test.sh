...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		"myRainbarf 235 ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR}"
		#"earthquake 3 0"
		# "pwd 89 211"
		...
		#"xkb_layout 125 117"
		"date_day 0 ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR}"
		# "date 235 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time 0 ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
