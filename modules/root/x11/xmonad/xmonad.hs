...
myFontGrid :: String
myFontGrid = "xft:CodingFontTobi:regular:size=8:antialias=true:hinting=true"
...
myShowWNameTheme = def
  { swn_font              = "xft:CodingFontTobi:size=45"
  , swn_fade              = 1.0
...
myKeys c =
  ...
  , ("C-M1-1", addName "Menu of games"           $ spawnSelected' gsGames)
  , ("C-M1-3", addName "Menu of Internet apps"   $ spawnSelected' gsInternet)
